...
set.seed(1839)
library(caret)
inTrain = createDataPartition(train_data$classe,p=0.60,list = FALSE)
...
Accuracy is 100% on validation Set.The out of Sample error is 0 here. The method I chose, classified the validation set 100% accurately.No need of model improvisation or any other model.
